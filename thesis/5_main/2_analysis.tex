...
Для первої нерівності можливі три випадки:
\begin{enumerate}
  \item
  ...
  \item
    ...
    \end{equation*}
  \item
    коли максимум досягається у проміжку $\left( t_1; t_6 \right)$
    \begin{equation*}
      \begin{cases}
    ...
    \begin{equation*}
      b \notin
      \left[4 \cdot \sqrt{- a \cdot \varepsilon} + 2 \cdot a \cdot t_1;\:
      4 \cdot \sqrt{- a \cdot \varepsilon} - 2 \cdot a \cdot t_1 \right]
    \end{equation*}
    або
    \begin{equation*}
      \left( b + 2 \cdot a \cdot t_1 \right)^2 \ge - 4 \cdot a \cdot \varepsilon.
    \end{equation*}
\end{enumerate}
