...
Спочатку треба визначити ймовірність $\rho_i^k$ того, що випадкова величина $\xi^k$
з функцією розподілу $F^k$ потрапить в $I_i^k$
\begin{equation*}
...
\begin{equation*}
  ...
  \qquad k = \overline{1,p}
\end{equation*}
Згадуючи центральну граничну теорему, бачимо, що корінь кожного доданку є
випадковою величиною, розподіл якої прямує до стандартного нормального з ростом
$p$
\begin{equation*}
  \sqrt{p \cdot \frac{\left( h_i^k - \rho_i^k \right)^2}{\rho_i^k}}
  = \sqrt{p} \cdot \frac{h_i^k - \rho_i^k}{\sqrt{\rho_i^k}}
  \Covergencen{p} N\left( 0, 1 \right)
\end{equation*}
Маємо суму $p$ квадратів залежних випадкових величин, що мають стандартний
гаусовський розподіл.
Хотілося б мати на виході розподіл суми квадратів незалежних стандартних
гаусовських випадкових величин --- розподіл Пірсона $\chi^2$.
Виявляється\cite{Pearson:1900}, що залежність отриманих випадкових величин
забирає лише один ступінь вільності, і на виході отримуємо розподіл Пірсона з
$N-1$ ступенями вільності
\begin{equation*}
...
елементів.
Тобто такого роду залежність між стовбчиками гістограми згубила один ступінь
вільності.

З таблиці для функції розподілу $\chi_{N-1}^2$ обираємо рівень значимості
$\alpha$ і шукаємо відповідне $r_{\alpha}$.
Рівень значимості --- ймовірність помилки першого роду --- ймовірність того, що
