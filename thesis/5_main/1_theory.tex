...
Також бачимо, що рівна крива може бути отримана, якщо зменшити впадину між
двома горбами на графіку --- примусити швидше працювати механізми, що збуджують
адаптованість.
...
\begin{figure}[h]
  ...
  \begin{subfigure}[b]{0.4\textwidth}
    \resizebox{\textwidth}{!}{\includegraphics{code/strange}}
    \caption{Задовільні результати}
    \label{fig:poisson:strange}
  \end{subfigure}
  \begin{subfigure}[b]{0.4\textwidth}
    \resizebox{\textwidth}{!}{\includegraphics{code/wrong}}
...
Щоб враховувати адаптованість, потрібно додати ще одне джерело з рідиною,
з якого вона буде виливатися в досліджувану цистерну.
Відомо, що
\begin{enumerate}
  \item Механізм запускається поступово після того, як розпочата активна робота
    \begin{equation*}
      \upsilon_2\left( 0 \right) = 0
    \end{equation*}
  \item До певного моменту часу $\tau$ виливається весь вміст додаткової
    цистерни --- вона стає пустою
    \begin{equation*}
      h_2\left( \tau \right) = 0
    \end{equation*}
...
З другого та третього фактів легко знайти об’єм допоміжної цистерни звичайним
інтегруванням
\begin{equation*}
  V_2
  = \int\limits_{0}^{\tau} \upsilon \; dt
  = - \mu \cdot S \cdot \sqrt{h_0}
    \cdot \left( 1 - \frac{\mu \cdot S}{4 \cdot \sqrt{h_0}} \cdot \tau^2 \right)
\end{equation*}
